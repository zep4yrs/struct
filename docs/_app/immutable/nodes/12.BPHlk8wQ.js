import{$ as e,E as t,U as n,et as r,nt as i,w as a}from"../chunks/BALd5B-z.js";import"../chunks/xihTtKlq.js";import{n as o,r as s,t as c}from"../chunks/BDAUe4jE.js";function l(e,t){let n=e.trim(),r=0;function i(){return n[r]??``}function a(){return n[r++]??``}function o(){for(;r<n.length&&/\s/.test(n[r]);)r++}function s(){let e=/^-?\d+(\.\d+)?/.exec(n.slice(r));return e?(r+=e[0].length,parseFloat(e[0])):null}function c(){let e=/^[a-zA-Z_]\w*/.exec(n.slice(r));return e?(r+=e[0].length,e[0]):null}function l(){o();let e=i();if(e===`(`){a();let e=d();return o(),e===null||i()!==`)`?null:(a(),e)}if(e===`+`||e===`-`){a();let t=l();return t===null?null:e===`-`?-t:t}if(/[0-9.]/.test(e))return s();let n=c();if(n!==null){let e=t(n);if(e===void 0)return null;let r=typeof e==`number`?e:Number(e);return Number.isFinite(r)?r:null}return null}function u(){let e=l();if(e===null)return null;for(;;){o();let t=i();if(t!==`*`&&t!==`/`)break;a();let n=l();if(n===null)return null;if(t===`/`){if(n===0)return null;e/=n}else e*=n}return e}function d(){let e=u();if(e===null)return null;for(;;){o();let t=i();if(t!==`+`&&t!==`-`)break;a();let n=u();if(n===null)return null;e=t===`+`?e+n:e-n}return e}let f=d();return f===null?null:(o(),r===n.length?f:null)}var u=[{name:`计算员工平均工资`,description:`DECLARE + SET + SELECT INTO + 简单算术`,body:`DECLARE 总工资 INT DEFAULT 0;
...
SELECT COUNT(*) INTO 人数 FROM 员工;
SET 平均工资 = 总工资 / 人数;
SELECT 平均工资 AS 结果;`,callArgs:[]};function u(e){let t=new f,n={name:e.name,params:[],body:e.body,callArgs:e.callArgs};return t.init(n),t}let d=n(u(l));s(t,{sectionNum:`§11`,sectionName:`数据库对象`,title:`存储过程`,desc:e=>{i();var t=p();i(4),a(e,t)},children:(e,t)=>{o(e,{get engine(){return d},topicId:`procedures`,topicName:`存储过程`})},$$slots:{desc:!0,default:!0}}),e()}export{m as component};