...
SELECT COUNT(*) INTO 人数 FROM 员工;
SET 平均工资 = 总工资 / 人数;
SELECT 平均工资 AS 结果;`,callArgs:[]};function u(e){let t=new f,n={name:e.name,params:[],body:e.body,callArgs:e.callArgs};return t.init(n),t}let d=n(u(l));s(i,{sectionNum:`§11`,sectionName:`数据库对象`,title:`存储过程`,desc:e=>{a();var n=p();a(4),t(e,n)},children:(e,t)=>{o(e,{get engine(){return d},topicId:`procedures`,topicName:`存储过程`})},$$slots:{desc:!0,default:!0}}),r()}export{m as component};