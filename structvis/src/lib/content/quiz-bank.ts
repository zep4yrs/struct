...
export const QUIZ_BANK: QuizQuestion[] = [
	...
	},
	{
		chapter: '树形结构',
		q: 'Trie 的核心思想是？',
		options: ['哈希', '公共前缀共享', '递归分治', '位运算'],
		answer: 1,
		explain: 'Trie 按公共前缀共享路径，cat 和 car 共用 c-a。',
		topicId: 'trie'
	},
	{
		chapter: '图结构',
	...
	},
	{
		chapter: '图结构',
		q: 'A* 的估价函数是？',
		options: ['f = g', 'f = g + h', 'f = h', 'f = g × h'],
		answer: 1,
		explain: 'f(n) = g(n) + h(n)：实际代价 + 启发式估计。',
		topicId: 'astar'
	},
	{
		chapter: '排序算法',
