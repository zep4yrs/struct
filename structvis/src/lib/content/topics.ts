...
export const dsTopics: TopicCard[] = [
	{
		title: '快速排序',
		description: '选一个基准，比它小的扔左边、大的扔右边，再对两边重复',
		href: '/ds/quick-sort',
		topicId: 'quick-sort',
		badge: '交互式',
	...
	{
		title: '二叉树遍历',
		description: '按不同顺序访问每个节点：先根、中根、后根，或一层层扫',
		href: '/ds/binary-tree',
		topicId: 'binary-tree',
		badge: '交互式',
	...
	{
		title: '单链表',
		description: '一串用指针连起来的节点，插删不用挪位置，找元素只能顺着爬',
		href: '/ds/linear-list',
		topicId: 'linear-list',
		badge: '交互式',
		hook: '为什么链表插入那么快，查找却要一个个跳？',
		exam: {
			how: '画指针变化图，写插入/删除的语句序列',
	...
	{
		title: '栈和队列',
		description: '栈只能从顶进出（后进先出），队列一头进另一头出（先进先出）',
		href: '/ds/stack-queue',
		topicId: 'stack-queue',
		badge: '交互式',
	...
	{
		title: '冒泡排序',
		description: '相邻两个比一比，大的往后换，每一轮最大的数就冒到了末尾',
		href: '/ds/bubble-sort',
		topicId: 'bubble-sort',
		badge: '交互式',
	...
	{
		title: '直接插入排序',
		description: '像整理扑克牌：每张新牌插进前面已经排好的部分里',
	...
	{
		title: '简单选择排序',
		description: '每轮从剩下的里挑最小的放到前面，交换次数最少的排序',
	...
	{
		title: '归并排序',
		description: '两个有序表合成一个有序表：从单个元素开始两两合并到整体',
		href: '/ds/merge-sort',
		topicId: 'merge-sort',
		badge: '交互式',
	...
	{
		title: '堆排序',
		description: '把数组看成一棵完全二叉树，每次取走堆顶，再把剩余调整成堆',
		href: '/ds/heap-sort',
		topicId: 'heap-sort',
		badge: '交互式',
	...
	{
		title: '希尔排序',
		description: '按间隔分组各自做插入排序，间隔逐轮缩小到 1',
		href: '/ds/shell-sort',
		topicId: 'shell-sort',
		badge: '交互式',
	...
	{
		title: '基数排序',
		description: '不比大小，按个位、十位……逐位「分发—收集」',
		href: '/ds/radix-sort',
		topicId: 'radix-sort',
		badge: '交互式',
	...
	{
		title: '计数排序',
		description: '数每个值出现了几次，再按顺序回填——值的范围小才划算',
	...
	{
		title: '图的存储',
		description: '邻接矩阵一行看出谁连谁，邻接表省空间但查边要遍历',
		href: '/ds/graph-storage',
		topicId: 'graph-storage',
		badge: '交互式',
		hook: '一万个点只有一百条边，用矩阵存要浪费多少？',
		exam: {
			how: '画邻接矩阵/邻接表，算边数与存储空间',
	...
	{
		title: '图的遍历',
		description: 'BFS 一层层扩散（用队列），DFS 一条路走到黑再回头（用栈/递归）',
		href: '/ds/graph-traversal',
		topicId: 'graph-traversal',
		badge: '交互式',
		hook: '走迷宫的两种策略：广撒网 vs 一条道走到黑',
		exam: {
			how: '按邻接表写出 BFS/DFS 访问序列',
	...
	{
		title: '最小生成树',
		description: '用最小的总边权把所有点连起来：Prim 逐点扩张，Kruskal 逐边挑选',
		href: '/ds/mst',
		topicId: 'mst',
		badge: '交互式',
	...
	{
		title: '最短路径',
		description: 'Dijkstra：每次把离起点最近的点定下来，再用它松弛邻居',
	...
	{
		title: '拓扑排序',
		description: '每次拿走入度为 0 的点——课程先修顺序就是这么排的',
		href: '/ds/topo-sort',
		topicId: 'topo-sort',
		badge: '交互式',
	...
	{
		title: '关键路径',
		description: 'AOE 网里耗时最长的那条路，决定整个工程的最短工期',
		href: '/ds/critical-path',
		topicId: 'critical-path',
		badge: '交互式',
		hook: '为什么整个工程最早完工时间由「最长的路」决定？',
		exam: {
			how: '计算各事件的 ve/vl，找出关键活动',
	...
	{
		title: '串的模式匹配（KMP）',
		description: '主串指针不回退，失配时模式串按 next 数组跳到该去的位置',
		href: '/ds/kmp',
		topicId: 'kmp',
		badge: '交互式',
	...
	{
		title: 'Sunday 匹配',
		description: '失配时看主串参与匹配段后面那一格的字符，按偏移表大步跳',
		href: '/ds/sunday',
		topicId: 'sunday',
		badge: '交互式',
		hook: '比 KMP 跳得更远的匹配，诀窍是「多看后面一格」',
		exam: {
			how: '写偏移表与每一步的移动距离',
	...
	{
		title: '最长回文子串',
		description: '插分隔符后利用已算出的回文半径对称加速，线性找最长回文',
		href: '/ds/manacher',
		topicId: 'manacher',
		badge: '交互式',
		hook: '中心扩展最坏 O(n²)，Manacher 为什么能 O(n)？',
		exam: {
			how: '小规模串写出 p 数组的计算过程',
	...
	{
		title: '二叉搜索树',
		description: '左子树都比它小、右子树都比它大，查找时每次决定走左还是走右',
		href: '/ds/bst',
		topicId: 'bst',
		badge: '交互式',
	...
	{
		title: '哈夫曼树',
		description: '每次取权值最小的两棵树合并——权值越大离根越近',
		href: '/ds/huffman',
		topicId: 'huffman',
		badge: '交互式',
	...
	{
		title: 'AVL 树',
		description: '任何节点左右子树高度差不超过 1，插入后旋转恢复平衡',
		href: '/ds/avl',
		topicId: 'avl',
		badge: '交互式',
	...
	{
		title: '二分查找',
		description: '每次与中间元素比一下，查找范围直接砍一半',
	...
	{
		title: '哈希表',
		description: '用函数直接算出存储位置，撞车了就按规则另找位置',
		href: '/ds/hash-table',
		topicId: 'hash-table',
		badge: '交互式',
	...
	{
		title: '哈希表 · 线性探测',
		description: '冲突就顺次往后挪一格找空位——堆在一起会越探越远',
	...
	{
		title: '红黑树',
		description: '用红黑两色维持「近似平衡」，插入删除最多转三次就稳',
		href: '/ds/rbtree',
		topicId: 'rbtree',
		badge: '交互式',
	...
	{
		title: 'A* 寻路',
		description: '优先扩展 f=g+h 最小的点，h 是到终点的估计距离',
		href: '/ds/astar',
		topicId: 'astar',
		badge: '交互式',
	...
	{
		title: '并查集',
		description: '每个集合一棵树，find 找到代表元素，union 把两棵树合并',
		href: '/ds/union-find',
		topicId: 'union-find',
		badge: '交互式',
	...
	{
		title: 'Tarjan 强连通分量',
		description: '一次 DFS 用 dfn/low 两个数，把「互相可达」的点打包成组',
		href: '/ds/tarjan',
		topicId: 'tarjan',
		badge: '交互式',
	...
	{
		title: '割点检测',
		description: '删掉它图就断开的点；DFS 里用 low 与 dfn 比出来',
	...
	{
		title: 'LCA 最近公共祖先',
		description: '倍增预处理每个点的 2^k 级祖先，查询时两点同步上跳',
		href: '/ds/lca',
		topicId: 'lca',
		badge: '交互式',
	...
	},
	{
		...
		description: '所有边松弛 n-1 轮，能处理负权；再松弛还能动就有负环',
	...
	},
	{
		...
		description: '反复找从源点到汇点的增广路推流量，直到一条都找不到',
		href: '/ds/max-flow',
		topicId: 'max-flow',
		badge: '交互式',
	...
	{
		title: '二分图判定',
		description: '染色法：相邻点颜色必须相反，染出冲突就不是二分图',
		href: '/ds/bipartite',
		topicId: 'bipartite',
		badge: '交互式',
	...
	{
		title: 'B+ 树插入',
		description: '多路平衡树：叶子满了就分裂，键上提到父层——数据库索引的地基',
	...
	{
		title: '单调栈',
		description: '栈里保持单调，新元素把挡路的都弹出去——每个元素只进出一次',
		href: '/ds/mono-stack',
		topicId: 'mono-stack',
		badge: '交互式',
		hook: '「下一个更大元素」这类题，为什么 O(n) 就能全部算完？',
		exam: {
			how: '写出入栈出栈的序列与对应答案',
	...
	{
		title: '跳表 Skip List',
		description: '给有序链表加多层快速通道，查找像走高架桥',
		href: '/ds/skip-list',
		topicId: 'skip-list',
		badge: '交互式',
	...
	},
	{
		...
		description: '下标按 lowbit 分层管理，前缀和与单点更新都是 O(log n)',
	...
	{
		title: 'LRU 缓存',
		description: '哈希表负责定位、双向链表管新旧顺序，淘汰永远从尾部走',
		href: '/ds/lru-cache',
		topicId: 'lru-cache',
		badge: '交互式',
	...
	{
		title: 'N 皇后回溯',
		description: '一行放一个皇后，列和对角线冲突就回退换位置',
		href: '/ds/n-queens',
		topicId: 'n-queens',
		badge: '交互式',
		hook: '8×8 棋盘放 8 个皇后互不攻击，解是怎么系统找出来的？',
		exam: {
			how: '画回溯树，写剪枝条件',
	...
	{
		title: '0-1 背包',
		description: '每件东西选或不选：f[i][j] = max(不选它, 选它)',
		href: '/ds/knapsack',
		topicId: 'knapsack',
		badge: '交互式',
	...
	{
		title: '最长公共子序列',
		description: '字符相等取左上 +1，否则取上、左中较大的，表格回溯出序列',
		href: '/ds/lcs',
		topicId: 'lcs',
		badge: '交互式',
	...
	{
		title: '最长递增子序列 LIS',
		description: 'f[i] = 前面比它小的 f 里最大的 +1；贪心加二分能到 O(n log n)',
		href: '/ds/lis',
		topicId: 'lis',
		badge: '交互式',
		hook: '合唱队形问题，为什么出队两次 LIS 就能解决？',
		exam: {
			how: '写出 f 数组并给出 LIS 长度',
	...
	{
		title: '编辑距离',
		description: '一个词最少几步（增/删/改一个字符）能变成另一个词',
		href: '/ds/edit-distance',
		topicId: 'edit-distance',
		badge: '交互式',
		hook: '拼写检查的「你是不是想找」，相似度就是这么算的',
		exam: {
			how: '画完整 DP 表',
	...
	{
		title: '矩阵链乘法',
		description: '加括号决定先算谁，区间 DP 枚举每个区间的最优切分点',
		href: '/ds/matrix-chain',
		topicId: 'matrix-chain',
		badge: '交互式',
		hook: '矩阵乘法的结合顺序不同，计算量能差十倍',
		exam: {
			how: '写 m 表与 s 表',
	...
	{
		title: '完全背包',
		description: '每件东西可以拿无限件，一维数组正序循环就能转移',
		href: '/ds/complete-knapsack',
		topicId: 'complete-knapsack',
		badge: '交互式',
		hook: '从 0-1 背包到完全背包，为什么循环方向反过来就够了？',
		exam: {
			how: '对比画出两种背包的 DP 表',
...
export const dbTopics: TopicCard[] = [
	{
		title: 'MySQL 架构总览',
		description: '从连接器到存储引擎，一条 SQL 要过五道关',
		href: '/db/mysql-arch',
		topicId: 'mysql-arch',
		badge: '交互式',
		hook: '你敲下回车之后，这条 SQL 到底经历了什么？',
		exam: {
			how: '画架构分层图，说清各层职责',
	...
	{
		title: '锁机制与死锁',
		description: '写数据先加锁；互相等对方的锁就死锁，系统挑一个「牺牲」',
		href: '/db/lock-deadlock',
		topicId: 'lock-deadlock',
		badge: '交互式',
		hook: '两个事务互相等对方手里的锁，谁都不撒手怎么办？',
		exam: {
			how: '分析加锁顺序，指出死锁原因与解法',
			points: '排他锁；等待图检测死锁',
	...
	{
		title: 'InnoDB 日志体系',
		description: 'undo 记怎么撤销、redo 记怎么重做、binlog 给主从同步用',
		href: '/db/innodb-log',
		topicId: 'innodb-log',
		badge: '交互式',
		hook: '突然断电数据为什么不丢？因为提交时先写的是日志',
		exam: {
			how: '写出两阶段提交的完整流程',
	...
	{
		title: '主从复制',
		description: '主库写 binlog，从库拉回去重放——读写分离的地基',
		href: '/db/replication',
		topicId: 'replication',
		badge: '交互式',
		hook: '读请求是写请求的十倍，一台数据库撑不住怎么办？',
		exam: {
			how: '画三线程复制流程图',
	...
	{
		title: '数据库系统概述',
		description: '数据、数据库、DBMS 三者什么关系，三级模式怎么分层',
		href: '/db/overview',
		topicId: 'overview',
		badge: '交互式',
		hook: '数据库、DBMS、数据库系统，三个词到底怎么区分？',
		exam: {
			how: '名词解释；画三级模式两层映像图',
	...
	{
		title: 'MySQL 数据查询',
		description: 'SELECT 挑列、WHERE 挑行、GROUP BY 分组统计',
		href: '/db/sql',
		topicId: 'sql',
		badge: '分步执行',
		hook: '从一张大表里筛出「我要的那部分」，语句怎么写？',
		exam: {
			how: '写多条件查询语句并给出结果集',
	...
	{
		title: 'SQL 内连接 JOIN',
		description: '两表按条件配对，结果像滚雪球一样逐行长出来',
		href: '/db/join',
		topicId: 'join',
		badge: '分步执行',
		hook: '学生表和成绩表，怎么按学号拼成一张大表？',
		exam: {
			how: '写 JOIN 语句并手写结果集',
	...
	},
	{
		...
		description: '左表全部保留，右表没配上的位置填 NULL',
		href: '/db/left-join',
		topicId: 'left-join',
		badge: '分步执行',
		hook: '没有成绩的学生也要出现在名单里，内连接做不到怎么办？',
		exam: {
			how: '写 LEFT JOIN 语句与结果集',
	...
	},
	{
		...
		description: '按列分组，每组算出一个统计值：计数、平均、最大最小',
		href: '/db/group-by',
		topicId: 'group-by',
		badge: '分步执行',
		hook: '「每个班的平均分」这种统计，一句 SQL 怎么写？',
		exam: {
			how: '写 GROUP BY 配聚合函数的查询',
	...
	{
		title: 'SQL 子查询',
		description: '查询里套查询：先算里层的，外层拿结果当条件或当表',
		href: '/db/subquery',
		topicId: 'subquery',
		badge: '分步执行',
		hook: '「比平均分高的学生」——平均分本身就要先算一步',
		exam: {
			how: '把需求写成子查询与连接两种写法',
	...
	{
		title: '事务隔离级别',
		description: '读未提交、读已提交、可重复读、串行化，逐级封堵并发异常',
		href: '/db/isolation',
		topicId: 'isolation',
		badge: '分步执行',
		hook: '两个人同时转账，中间状态为什么不应该被对方看到？',
		exam: {
			how: '给异常场景判断属于哪个隔离级别的问题',
	...
	{
		title: '高级查询',
		description: 'HAVING 筛组、EXISTS 判存在、UNION 拼接结果',
		href: '/db/advanced-query',
		topicId: 'sql-advanced',
		badge: '分步执行',
		hook: '「平均分 80 分以上的班级」，WHERE 为什么写不了？',
		exam: {
			how: '综合多种写法完成查询需求',
	...
	{
		title: '窗口函数',
		description: '不折叠行，给每一行附上组内排名或累计值',
		href: '/db/window-function',
		topicId: 'window-function',
		badge: '分步执行',
		hook: '每科前两名全都要（并列也算），GROUP BY 为什么做不到？',
		exam: {
			how: '写 OVER(PARTITION BY ... ORDER BY ...) 查询',
	...
	{
		title: '执行计划与索引选择',
		description: 'EXPLAIN 告诉你这条 SQL 是全表扫描还是走了索引',
		href: '/db/explain-plan',
		topicId: 'explain-plan',
		badge: '分步执行',
		hook: '同一条 SQL 有时快有时慢，怎么看到底发生了什么？',
		exam: {
			how: '读 EXPLAIN 输出并判断执行方式',
	...
	{
		title: '建表练习',
		description: 'CREATE TABLE 定结构：每一列的类型、主键与约束',
		href: '/db/tables',
		topicId: 'tables',
		badge: '交互式',
		hook: '表建好之前，先想清楚每一列该放什么类型',
		exam: {
			how: '按需求写完整建表语句',
	...
	{
		title: '数据更新',
		description: 'INSERT 插行、UPDATE 改列、DELETE 删行',
		href: '/db/update',
		topicId: 'dml',
		badge: '分步执行',
		hook: '忘写 WHERE 的 UPDATE 会改掉整张表——这是真事',
		exam: {
			how: '按需求写三种更新语句',
	...
	{
		title: '索引原理',
		description: 'B+ 树把查找从「翻整本书」变成「查目录」',
		href: '/db/index',
		topicId: 'index',
		badge: '分步执行',
		hook: '索引让查询飞快，为什么不给每一列都建上？',
		exam: {
			how: '画 B+ 树插入与页分裂过程',
	...
	{
		title: '视图',
		description: '一条常用查询的快捷方式，用起来像一张表',
		href: '/db/view',
		topicId: 'view',
		badge: '分步执行',
		hook: '常用的复杂查询，能不能存成一张「虚拟表」？',
		exam: {
			how: 'CREATE VIEW 建视图并查询',
	...
	{
		title: '触发器',
		description: 'INSERT/UPDATE/DELETE 发生时，自动执行一段预设逻辑',
		href: '/db/triggers',
		topicId: 'triggers',
		badge: '分步执行',
		hook: '下单后自动扣库存，这个「自动」是怎么实现的？',
		exam: {
			how: '写 BEFORE/AFTER 触发器',
	...
	{
		title: '存储过程',
		description: '存在数据库里的「小程序」：参数、变量、IF/WHILE 流程',
		href: '/db/procedures',
		topicId: 'procedures',
		badge: '分步执行',
		hook: '一套业务逻辑直接存进数据库，应用程序调用就行',
		exam: {
			how: '写带参数的存储过程并调用',
	...
	{
		title: 'E-R 模型',
		description: '实体、属性、联系三要素画概念模型，再转成关系表',
		href: '/db/er',
		topicId: 'er',
		badge: '分步执行',
		hook: '需求文档怎么一步步变成数据库设计图？',
		exam: {
			how: '画 E-R 图并转换为关系模式',
	...
	{
		title: '关系规范化',
		description: '函数依赖决定哪些列放一起，范式逐级消除冗余',
		href: '/db/normalize',
		topicId: 'normalize',
		badge: '分步执行',
		hook: '一张表里学生的院系电话重复了一百次，问题出在哪？',
		exam: {
			how: '判断给定关系模式的范式级别并分解',
	...
	{
		title: '事务与并发控制',
		description: 'ACID 四个特性；并发执行要靠隔离级别护航',
		href: '/db/transaction',
		topicId: 'transaction',
		badge: '分步执行',
		hook: '转账要么都成功要么都失败，数据库怎么保证？',
		exam: {
			how: '名词解释 + 场景分析题',
	...
	{
		title: '用户与权限管理',
		description: '建用户、授权限（GRANT）、做备份恢复',
		href: '/db/users',
		topicId: 'users',
		badge: '交互式',
		hook: '给实习生开一个只读账号，怎么控制他能看什么？',
		exam: {
			how: '写 GRANT/REVOKE 语句',
	...
	{
		title: 'SQL 函数演练',
		description: '字符串截取拼接、数值四舍五入、日期格式化、NULL 兜底',
		href: '/db/sql-functions',
		topicId: 'sql-functions',
		badge: '真实执行',
		hook: '把手机号中间四位打成星号，一句函数怎么写？',
		exam: {
			how: '写函数组合的查询语句',
	...
	{
		title: 'CASE 表达式',
		description: '行内条件分支：按分数段打标签、行转列统计',
		href: '/db/case-expr',
		topicId: 'case-expr',
		badge: '真实执行',
		hook: '60 分以下标「不及格」，SQL 里怎么写 if-else？',
		exam: {
			how: '写搜索 CASE 完成分类统计',
	...
	},
	{
		...
		description: 'WHERE 先筛行，GROUP BY 分组后 HAVING 再筛组',
		href: '/db/having-deep',
		topicId: 'having-deep',
		badge: '真实执行',
		hook: '都是筛选，为什么非要用两个不同的关键词？',
		exam: {
			how: '写等价写法与不等价写法的对比',
	...
	{
		title: 'DISTINCT 与分页',
		description: 'DISTINCT 去重、LIMIT 翻页，以及「页越深越慢」的原因',
		href: '/db/distinct-paging',
		topicId: 'distinct-paging',
		badge: '真实执行',
		hook: '翻到第 10000 页为什么比第 1 页慢得多？',
		exam: {
			how: '写去重与分页语句',
	...
	{
		title: 'SQL 集合运算',
		description: 'UNION 并、INTERSECT 交、EXCEPT 差；两边列结构必须一致',
		href: '/db/union-set',
		topicId: 'union-set',
		badge: '真实执行',
		hook: '「选了 A 或 B 的学生」和「两门都选的」，怎么一次查出来？',
		exam: {
			how: '写三种集合运算语句',
	...
	{
		title: 'JOIN 家族',
		description: 'RIGHT、FULL、CROSS、自连接——每种 JOIN 各自保留谁',
		href: '/db/join-variants',
		topicId: 'join-variants',
		badge: '真实执行',
		hook: '员工表里「经理也是员工」，一张表怎么连接自己？',
		exam: {
			how: '写各种 JOIN 并给出结果集',
			points: '自连接必须起两个别名',
	...
	{
		title: '视图更新限制',
		description: '简单视图能改，带聚合、分组、多表拼接的视图不能改',
		href: '/db/view-update',
		topicId: 'view-update',
		badge: '真实执行',
		hook: '为什么有的视图能 UPDATE，有的直接报错？',
		exam: {
			how: '判断给定视图是否可更新',
	...
	{
		title: '约束体系',
		description: '主键、唯一、非空、检查、外键——数据的五道防线',
		href: '/db/constraints',
		topicId: 'constraints',
		badge: '真实执行',
		hook: '防止脏数据进表，数据库层面能设哪些卡？',
		exam: {
			how: '写带各种约束的建表语句',
	...
	{
		title: '索引查询与回表',
		description: '二级索引先找到主键，还要回主键树取整行；只查索引列就不用回',
		href: '/db/index-query',
		topicId: 'index-query',
		badge: '概念演示',
		hook: '为什么 SELECT * 比 SELECT 索引列慢？',
		exam: {
			how: '分析查询是否用上覆盖索引',
	...
	{
		title: '索引失效实验',
		description: '列上套函数、隐式转换、前导 %……索引说失效就失效',
		href: '/db/index-fail',
		topicId: 'index-fail',
		badge: '真实执行',
		hook: '明明建了索引，为什么还是全表扫描？',
		exam: {
			how: '用 EXPLAIN 判断每种写法是否走索引',
			points: '五种常见失效场景',
	...
	{
		title: 'EXPLAIN 详解',
		description: '读执行计划：谁先执行、扫多少行、用没用上索引',
		href: '/db/explain-detail',
		topicId: 'explain-detail',
		badge: '真实执行',
		hook: 'EXPLAIN 输出十几列，到底重点看哪几列？',
		exam: {
			how: '解读给定执行计划的每一列',
	...
	{
		title: '锁等待与死锁甘特图',
		description: '两个事务的加锁时间线一交叉，死锁现场一目了然',
		href: '/db/lock-gantt',
		topicId: 'lock-gantt',
		badge: '概念演示',
		hook: '死锁发生之后，怎么从日志里还原案发现场？',
		exam: {
			how: '根据事务序列画锁等待图',
			points: '循环等待 = 死锁的充要条件',
	...
	{
		title: '可串行化调度',
		description: '冲突操作对不交换顺序的串行序列，就是等价的并发调度',
		href: '/db/serial-schedule',
		topicId: 'serial-schedule',
		badge: '概念演示',
		hook: '并发执行怎么证明它「等价于」某个串行执行？',
		exam: {
			how: '画前趋图并做拓扑排序',
	...
	{
		title: 'SQL 工作台',
		description: '亲手写 SQL：真实执行、逐关解锁、即时判分反馈',
		href: '/db/workbench',
		topicId: 'sql-workbench',
		badge: '关卡制',
		hook: '看会了不等于会写——来这里亲手敲',
		exam: {
			how: '实操题：按需求写出并通过执行的 SQL',
