...
<div class="mx-auto max-w-7xl px-8 py-16">
	...
	<section class="mb-16">
		...
		<p class="max-w-3xl text-base leading-relaxed" style="color: var(--color-ink-2);">
			v1.0 正式版。已实现数据结构 19 课：排序（快速/冒泡/插入/选择/归并）、树（二叉树遍历/二叉搜索树/哈夫曼）、图（存储/遍历/最短路径/最小生成树/拓扑排序/关键路径）、线性表、栈和队列、KMP、二分查找、哈希表。已实现数据库 9 课：SELECT 查询、高级查询、数据更新、视图、索引、触发器、存储过程、事务与并发、E-R 模型、关系规范化、用户权限管理。全部支持步进可视化、即时练习反馈、错题本与掌握度追踪。
		</p>
	</section>
